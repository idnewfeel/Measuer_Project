...
static void ui_event_RightBtn(lv_event_t * e)
{
    ...
    if(event == LV_EVENT_CLICKED) {
        _ui_screen_change(ui_Debug, LV_SCR_LOAD_ANIM_OVER_BOTTOM, 500, 0);
    }
}
...
static void ui_event_TDetail(lv_event_t * e)
{
    lv_event_code_t event = lv_event_get_code(e);
    lv_obj_t * ta = lv_event_get_target(e);
    if(event == LV_EVENT_CLICKED) {
...
void ui_Main_screen_init(void)
{
    ...
    lv_obj_set_style_bg_img_src(ui_MidBtn, &ui_img_detail_png, LV_PART_MAIN | LV_STATE_DEFAULT);
    ...
    lv_obj_set_style_bg_img_src(ui_LeftBtn, &ui_img_menu_png, LV_PART_MAIN | LV_STATE_DEFAULT);
    ...
    lv_label_set_text(ui_TVOCVal, "0.25");
...
void ui_TDetail_screen_init(void)
{
    ...
    lv_obj_add_event_cb(ui_TDetail, ui_event_TDetail, LV_EVENT_ALL, NULL);
...
void ui_TVOCDetail_screen_init(void)
{
    ...
    lv_label_set_text(ui_TVOCVal1, "0.25");
