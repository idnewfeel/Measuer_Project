...
//PWM调背光
#define LCD_BLK_Clr(a)  (TIM3->CCR4=(100-a))
#define LCD_BLK_Set(a)  (TIM3->CCR4=(100-a))

// #define LCD_BLK_Clr()  HAL_GPIO_WritePin(BLK_GPIO_Port,BLK_Pin,GPIO_PIN_SET)
// #define LCD_BLK_Set()  HAL_GPIO_WritePin(BLK_GPIO_Port,BLK_Pin,GPIO_PIN_RESET)
